...
class Album(models.Model):
    ...
    def __str__(self):
        return f'{self.title} {self.matrix} {self.release_date} {self.country_of_pressing} {self.artist} {self.publisher}'
...
class Song(models.Model):
    ...
    def __str__(self):
        return f'{self.title} {self.length} {self.artist} {self.album}'
